...
Это нужно для того, чтобы к этому действию можно было вернуться и, возможно, восстановить, нажав на определенные кнопки.
Поведенческие паттерны Memento можно рассмотреть и на примере текстового редактора, который периодически делает сохранения.
У нас есть объект, который сможет удерживать состояние редактора:
<?php
class EditorMemento
{
    protected $content;
